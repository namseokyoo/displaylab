...
const en = {
  ...
  common: {
    ...
    dataStaysLocal: 'Uploaded analysis data stays in your browser',
  ...
  home: {
    ...
    badgeStandard: 'Reference-tested calculations',
    badgeFree: 'Free \u2014 no account required',
    toolsHeading: 'Analysis Tools',
    statProcessing: 'Client-side Processing',
    statProcessingSub: 'Analysis inputs are processed locally',
    statValidated: 'Reference Tested',
  ...
  cri: {
    ...
    lightQualityDesc: 'Approximate color rendering indicators from simplified sample models; not a standards-compliance result.',
    experimentalStatus: 'Experimental calculations',
    experimentalStatusDesc: 'CRI, TM-30, and TLCI are not yet validated against their complete authoritative methods.',
    experimentalEstimate: 'Experimental estimate',
    noDecisionUse: 'Do not use these estimates for procurement, broadcast, compliance, or safety decisions.',
    criRa: 'CRI-style estimate',
    tm30Rf: 'TM-30-style Rf',
    tm30Rg: 'TM-30-style Rg',
    tlciQa: 'TLCI-style Qa',
    generalCri: 'Simplified model output',
    fidelityIndex: 'Simplified fidelity output',
    gamutIndex: 'Simplified gamut output',
    tvLighting: 'Simplified camera output',
    excellent: 'Excellent',
    good: 'Good',
    fair: 'Fair',
    poor: 'Poor',
    ...
    // CRI Results
    criTitle: 'Estimated CRI (Color Rendering Index)',
    criEmpty: 'Load spectrum data to calculate CRI Ra and R1-R14 scores.',
    criReference: 'Simplified CIE 13.3 model \u2014 Reference:',
    ...
    r14Leaf: 'R14 (Leaf)',
    // TM-30
    tm30Title: 'TM-30-style Color Vector Graphic (Approximation)',
    tm30Desc: 'Approximate 16-bin comparison in the CIELAB a*b* plane. This is not an IES compliance result.',
    fidelity: 'Rf-style output',
    gamut: 'Rg-style output',
    expandedGamut: 'Expanded gamut',
    reducedGamut: 'Reduced gamut',
    neutralGamut: 'Neutral gamut',
    // TLCI
    tlciTitle: 'Estimated TLCI (Television Lighting Consistency Index)',
    tlciDesc: 'Simplified estimate of broadcast-camera color rendering; not an EBU compliance result.',
    tlciEmpty: 'Load spectrum data to calculate TLCI.',
    tlciScore: 'Qa-style output',
