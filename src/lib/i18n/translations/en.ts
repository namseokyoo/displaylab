...
const en = {
  ...
  cri: {
    ...
    generalCri: 'General index (R1-R8 average)',
    excellent: 'Excellent',
    good: 'Good',
    fair: 'Fair',
    poor: 'Poor',
    ...
    // CRI Results
    criTitle: 'Estimated General CRI Ra',
    criEmpty: 'Load spectrum data to calculate a general CRI Ra estimate.',
    criReference: 'Experimental CIE 13.3 implementation \u2014 Reference:',
