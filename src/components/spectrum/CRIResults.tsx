    ...
    return (
      <div className="p-6 rounded-xl bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-800">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Load spectrum data to calculate CRI Ra and R1-R14 scores.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 rounded-xl bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-800">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
        CIE 13.3-1995 &mdash; Reference: {result.referenceType === 'planckian' ? 'Planckian' : 'CIE D-series'} at {result.cct}K
      </p>
      ...
      <div className="flex items-center gap-4 mb-6 p-4 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/60">
        <div className="text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">General CRI</p>
      ...
      <div className="space-y-1.5">
        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Individual Scores (R1-R14)</p>
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-2.5 dark:border-gray-700/60 dark:bg-gray-800/50 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">R9 (Red)</p>
          <p className={`text-lg font-semibold ${getRatingColor(result.Ri[8])}`}>
            {result.Ri[8].toFixed(1)}
          </p>
        </div>
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-2.5 dark:border-gray-700/60 dark:bg-gray-800/50 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">R13 (Skin)</p>
          <p className={`text-lg font-semibold ${getRatingColor(result.Ri[12])}`}>
            {result.Ri[12].toFixed(1)}
          </p>
        </div>
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-2.5 dark:border-gray-700/60 dark:bg-gray-800/50 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">R14 (Leaf)</p>
